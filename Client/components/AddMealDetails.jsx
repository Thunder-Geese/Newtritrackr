  ...
  render() {
    ...
    for (let i = 0; i < this.props.ingredientList.length; i++) {
      ingredientsDisplay.push(
        <div className='ingredientListText' key={i}>
          {this.props.ingredientList[i]}
        </div>
      );
    }
...
*/
    return (
      <div className='addMealWrapper'>
        {this.props.displayMealNamePopup ? (
          <AddMealName
        ...
        <div className='addMealDetails'>
          <button
            onClick={() => this.props.addMealDetails()}
          ...
          <div className='addMealDetailsWrapper'>
            ...
            <div className='addMealTextList'>
              Add ingredients one at a time. After adding all your ingredients,
              click submit.
            </div>
            <div className='ingredientList'>{ingredientsDisplay}</div>
            <form
              onSubmit={(event) => this.props.addIngredient(foodName, event)}
              autoComplete='off'
            ...
            >
              <div>
                <input
                  ref={foodName}
                  placeholder='Add your meal ingredient here'
            ...
            <div className='addMealText'>
              ...
              <button
                value='Log In'
                className='submitMealButton'
                onClick={() => this.props.mealNamePopup()}
              >
                Submit Meal
              </button>
            </div>
