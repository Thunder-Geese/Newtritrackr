    ...
    return (
      <div className='loginWrapper'>
        ...
        <div className="signupDetails">
          <button onClick={() => this.props.signupDetails()} className='closeDetails'>X</button>
          <div className='inputWrapper'>
            ...
            <form onSubmit={(event) => this.props.submitSignup(usernameText, passwordText, ageText, heightText, sexText, weightText, event)} autoComplete='off'>
              ...
              <input ref={usernameText} type='username' placeholder='username' className='loginInput'></input>
              ...
              <input ref={ageText} type='age' placeholder='age in years' className='loginInput'></input>
              <div className='loginText'>Please input your height in inches.</div>
